  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-[#f0f0f0]">
          ...
          <AreaChart data={curveData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
            <defs>
              <linearGradient id="memoryGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#00c288" stopOpacity={0.2}/>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-[#767676] mb-2">
                현재 기억 유지율 {currentMemoryRate}%
              </p>
              <p className="text-xs text-[#999999]">
                복습을 통해 기억을 강화할 수 있습니다
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex gap-3 mt-4">
        ...
        <button className="flex-1 py-3 bg-[#00c288] text-white rounded-xl font-medium hover:bg-[#00a876] transition-colors">
          복습 시작
        </button>
      </div>
    </div>
